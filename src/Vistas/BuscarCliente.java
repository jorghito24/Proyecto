...
//        jtxt_correo.setEnabled(false);
    ...
    private void jbtn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtn_eliminarActionPerformed
        try {
            Conexion cn = new Conexion();
            Connection cnx = cn.conexion();
            String query = "DELETE rut_cliente, dv_rut,nombre,ap_paterno,ap_materno,telefono,correo FROM cliente WHERE rut_cliente =? and dv_rut=?";
            PreparedStatement stmt = cnx.prepareStatement(query);
            stmt.setInt(1, Integer.parseInt(jtxt_rut.getText()));
            stmt.setString(2, jtxt_dv.getText());
            ResultSet rs = stmt.executeQuery();
            JOptionPane.showMessageDialog(this, "Se a Eliminado Correctamente el Cliente","Aviso",1);
            rs.close();
            stmt.close();
            cnx.close();
